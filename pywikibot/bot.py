...
__version__ = '$Id: 4785117924415986b00520c21942c4ef47c12d94 $'
...
def handle_args(args=None, do_help=True):
    ...
    if config.verbose_output:
        ...
        # replacement with `$Id: 4785117924415986b00520c21942c4ef47c12d94 $`
        # or `$Id: 4785117924415986b00520c21942c4ef47c12d94 $`.
        m = re.search(r"\$Id"
